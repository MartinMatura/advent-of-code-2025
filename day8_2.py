...
pos_in_circuits = 0 # count junctions that are in circuits
...
last_connection = None # track last connection made (needed for solution)

# make connections until all junctions are in 1 circuit
while pos_in_circuits < 1000 or len(circuits) > 1:
